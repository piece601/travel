...
class BASE_Model extends CI_Model
{
    ...
    {
        $this->_database->where_in($this->primaryKey, $values);
    ...
    public function update($primary_value, $data, $skip_validation = FALSE)
    {
        ...
        if ($data !== FALSE)
        {
            $result = $this->_database->where($this->primaryKey, $primary_value)
                               ->set($data)
                               ->update($this->table);
    ...
    public function update_many($primary_values, $data, $skip_validation = FALSE)
    {
        ...
        if ($data !== FALSE)
        {
            $result = $this->_database->where_in($this->primaryKey, $primary_values)
                               ->set($data)
                               ->update($this->table);
    ...
    public function delete_many($primary_values)
    {
        ...
        $this->_database->where_in($this->primaryKey, $primary_values);
    ...
    private function _fetch_primary_key()
    {
        ...
        {
            $this->primaryKey = $this->_database->query("SHOW KEYS FROM `".$this->table."` WHERE Key_name = 'PRIMARY'")->row()->Column_name;
        }
    }
